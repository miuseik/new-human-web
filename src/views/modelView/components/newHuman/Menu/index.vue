                      ...
                      <div class="item-set" v-if="state.currentChange.includes(item.id)">
                            <template v-for="(grid, key) in item ">
                                <div v-if="key.toString() === 'size'" class="item-set-bar">
                                    ...
                                    <input class="input-box" type="text" v-model="state.boneList[index][key]"
                                           @input="setInputVal"
                                ...
                                <div v-else-if="key.toString() === 'position' || key.toString() === 'rotate'"
                                     class="item-set-bar">
                                    <span class="title">{{ key }}</span>
                                    x:<input type="text" class="input-box" v-model="state.boneList[index][key]['x']"
                                             @input="setInputVal"
                                             :disabled="key.toString() === 'id'">
                                    y:<input type="text" class="input-box" v-model="state.boneList[index][key]['y']"
                                             @input="setInputVal"
                                             :disabled="key.toString() === 'id'">
                                    z:<input type="text" class="input-box" v-model="state.boneList[index][key]['z']"
                                             @input="setInputVal"
                                             :disabled="key.toString() === 'id'">
                                </div>
                                        ...
                                        <template v-for="(opt, index) in grid">
                                            <div class="option-item">
                                                ...
                                                <div class="option-input ">
                                                    <p>
                                                        <span>min:</span><input class="input-box" type="text"
                                                                                v-model="opt.min">
                                                    </p>
                                                    <p>
                                                        <span>max:</span><input class="input-box" type="text"
                                                                                v-model="opt.max">
                                                    </p>
                                                    <p>
                                                        <span>value:</span><input class="input-box" type="text"
                                                                                  v-model="opt.value">
                                                    </p>
                                                </div>
                                            </div>
