...
export default class baseManager {
		...
		initRobot () {
				const D1 = new THREE.Mesh (
						new THREE.CylinderGeometry (1, 1, 0.5, 10),
				...
				let D2geometry = new THREE.SphereGeometry (0.5, 32, 16)
				let D2material = new THREE.MeshStandardMaterial ({color    : "#1B1A17", metalness: 0, roughness: 0.5,});
				...
				let B1;
				loader.load ('/human/leg/Femur.STL', (geometry) => {
						let material = new THREE.MeshPhongMaterial ({color: 0xff9c7c, specular: 0x494949, shininess: 200});
						B1    = new THREE.Mesh (geometry, material);
						B1.position.set (0, -0, 0.6);
						B1.rotation.set (0, -Math.PI / 2, 0);
						B1.scale.set (0.02, 0.02, 0.02);
						B1.castShadow    = true;
						B1.receiveShadow = true;
						// this.scene.add (meshFemur);
						D2.add (B1);
				});
				//
				...
				//     const meshFemur = new THREE.Mesh( geometry, material );
				//     meshFemur.position.set( 0, - 0.25, 0.6 );
				//     meshFemur.rotation.set( 0, - Math.PI / 2, 0 );
				//     meshFemur.scale.set( 0.01, 0.01, 0.01 );
				//     meshFemur.castShadow = true;
				//     meshFemur.receiveShadow = true;
				//     this.scene.add( meshFemur );
				// } );
				this.scene.add (D1);
				this.D1 = D1;
